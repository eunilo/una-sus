#!/usr/bin/env python3
"""
💾 Scraper UNA-SUS - Backup Original
====================================

Este arquivo é uma cópia fiel do scraper_unasus_melhorado.py, armazenado como
backup para referência e segurança.

⚠️ IMPORTANTE:
- NÃO MODIFIQUE este arquivo
- Use como ponto de retorno se necessário
- Mantenha sempre intacto para comparações
- Referência para restaurar funcionalidade original

🔄 COMO USAR:
- Para restaurar: cp scraper_unasus_backup_original.py scraper_unasus_grounded.py
- Para comparação: diff scraper_unasus_grounded.py scraper_unasus_backup_original.py
- Para referência: consulte este arquivo para funcionalidades originais

📋 CONTEÚDO:
- Código original do scraper melhorado
- Configurações padrão
- Descritores DEIA originais
